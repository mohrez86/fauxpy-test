...
"pandas/tests/frame/indexing/test_categorical.py::TestDataFrameIndexingCategorical::test_setitem_single_row_categorical"
)
FAMILY="mbfl"
...
VENV_DIR="$HOME/bugsinpyenv$VENV_V"

FAUXPY_PATH="$SCRIPT_DIR/../fauxpy"
